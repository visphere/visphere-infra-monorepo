 ...
 */
package pl.visphere.account.security;
...
class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        securityService().configureStatelessSecurity(httpSecurity, "api/v1/account/**")
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/v1/account/check/prop/exist").permitAll()
                .requestMatchers("/api/v1/account/check/myaccounts/exists").permitAll()
                .requestMatchers("/api/v1/account/new/create").permitAll()
                .requestMatchers("/api/v1/account/new/activate/{token}").permitAll()
                .requestMatchers("/api/v1/account/new/activate/resend").permitAll()
