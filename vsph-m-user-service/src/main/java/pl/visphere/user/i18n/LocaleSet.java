...
public enum LocaleSet implements LocaleExtendableSet {
    ...
    REFRESH_TOKEN_EXPIRED_EXCEPTION_MESSAGE("vsph.user.exc.refreshTokenExpired"),
    MFA_IS_ALREADY_SETUP_EXCEPTION_MESSAGE("vsph.user.exc.mfaIsAlreadySetup"),
    MFA_NOT_ENABLED_EXCEPTION_MESSAGE("vsph.user.exc.mfaNotEnabled"),
    MFA_CURRENTLY_ENABLED_EXCEPTION_MESSAGE("vsph.user.exc.mfaCurrentlyEnabled"),
    MFA_CURRENTLY_DISABLED_EXCEPTION_MESSAGE("vsph.user.exc.mfaCurrentlyDisabled"),
    MFA_INVALID_CODE_EXCEPTION_MESSAGE("vsph.user.exc.mfaInvalidCode"),
    INVALID_OLD_PASSWORD_EXCEPTION_MESSAGE("vsph.user.exc.invalidOldPassword"),
    ACCOUNT_ALREADY_ENABLED_EXCEPTION_MESSAGE("vsph.user.exc.accountAlreadyEnabled"),
    ACCOUNT_ALREADY_DISABLED_EXCEPTION_MESSAGE("vsph.user.exc.accountAlreadyDisabled"),
    UNABLE_TO_DELETE_ACCOUNT_WITH_GUILDS_EXCEPTION_MESSAGE("vsph.user.exc.unableToDeleteAccountWithGuilds"),
